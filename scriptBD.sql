...
CONSTRAINT PK_BOLETAS PRIMARY KEY (ID_BOLETA),
CONSTRAINT FK_BOLETAS FOREIGN KEY (ID_PRODUCTO) REFERENCES PRODUCTOS (ID_PRODUCTO)
)
...
ALTER TABLE BOLETAS 
	 ADD CONSTRAINT FK_BOLETAS2 FOREIGN KEY (ID_VENTA)
	  REFERENCES VENTAS (ID_VENTA);
...
INSERT INTO PROMOCIONES VALUES (1, '2X1');
INSERT INTO PROMOCIONES VALUES (2, '3X2');
INSERT INTO PROMOCIONES VALUES (3, 'SIN PROMOCION');
...
INSERT INTO PRODUCTOS VALUES (1, 'Proplan Adulto Razas Medianas (Ex Complete) alimento para perro', 26990, 10, 2, 3);
INSERT INTO PRODUCTOS VALUES (2, 'Nath Puppy Mini sabor pollo y arroz café alimento para perros', 4990, 10, 2, 3);
INSERT INTO PRODUCTOS VALUES (3, 'Desparasitante Bravecto para perros 20 KG a 40 KG', 40515, 10, 2, 3);
INSERT INTO PRODUCTOS VALUES (4, 'Tearless shampoo cachorro - le salon 375 ML', 8690, 10, 2, 3);
INSERT INTO PRODUCTOS VALUES (5, 'Royal Canin adulto Mini Adult alimento para perro', 51905, 10, 2, 3);
...
--POBLAR TABLA BOLETAS

INSERT INTO BOLETAS VALUES (1, 2, 1, 26990);
INSERT INTO BOLETAS VALUES (2, 3, 2, 40515);
INSERT INTO BOLETAS VALUES (3, 3, 3, 40515);
INSERT INTO BOLETAS VALUES (4, 4, 4, 8690);
INSERT INTO BOLETAS VALUES (5, 5, 5, 51905);
